...
* [ArtifactParsers](https://github.com/Digital-Forensics-Discord-Server/ArtifactParsers) - Looking for a way to parse the artifacts found in this repo? Look no further! This is a comprehensive (will likely never be exhaustive) list of parsers for various artifacts, separated by whether they are CLI, GUI, or both. 
